public class PatternRobots {
	...
	public static void main(String[] args) {
		...
		Robot robot1= new RobotImpl.RobotBuilder("robot1")
				.puissance(10)
				.bouclier(2)
				.frequence(100).build();// un robot avec un canon de 10, un bouclier de 2, une fréquence de tir de 100 et qui a reçu une amélioration de canon multipliant la puissance de ce dernier par 2.
		CanonRobot canonRobot = new CanonRobot(robot1, 2);

		Robot robot2= new RobotImpl.RobotBuilder("robot2")
				.puissance(9)
				.bouclier(3)
				.frequence(90).build();// un robot avec un canon de 9, un bouclier de 3, une fréquence de tir de 90
		...
		BouclierRobot bouclierRobot = new BouclierRobot(robot2, 2);
		PointsDeVieRobot pointsDeVieRobot = new PointsDeVieRobot(bouclierRobot, 2);
		fight(canonRobot, pointsDeVieRobot);
	}
}
