...
import validation.GenerateurAmEx;
import validation.GenerateurDinersClub;
import validation.GenerateurDiscover;
import validation.GenerateurMasterCard;
import validation.GenerateurVisa;
		...
		try {
			...
			while (fichier.hasNextLine()) {
				try {
					...
					Generateur generateur = new GenerateurAmEx(new GenerateurDiscover(new GenerateurDinersClub(
							new GenerateurMasterCard(new GenerateurVisa(null)))));
